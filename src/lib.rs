...
#[derive(Debug)]
pub struct MintWorksProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MintWorksProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MintWorks processing");
    
    let mut processor = MintWorksProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MintWorksProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MintWorksProcessor::new(false);
